...
def setup
  ...
  task = Task.new ( {
    'headline' => 'Aardvark, aardvark, aardvark',
    'description' => 'A task to appear at the start of the list',
  ...
  task = Task.new ( {
    'headline' => 'Atomic mayhem',
    'description' => 'Mark\'s task',
    'create_date' => '2016-06-08',
    'target_date' => nil,
    'priority' => 1,
    'status' => 1,
    'created_by_user_id' => @user2.id,
    'category_id' => @cat_work.id,
    'allocated_executive_id' => @user2.my_executive_id,
    'allocated_user_id' => @user2.id,
    'is_deleted' => false
    } )
  task.save()
